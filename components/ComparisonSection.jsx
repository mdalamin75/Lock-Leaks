        ...
        <div className="flex justify-end mb-6 lg:mb-8">
          <div className="flex items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-2">
              <OptimizedImage src="/img/black_dot.svg" alt="Black Dot" className="w-4 h-3 object-contain" />
              <span className="text-xs sm:text-sm text-black">With others.</span>
            </div>
            <div className="flex items-center gap-2">
              <OptimizedImage src="/img/blue_dot.svg" alt="Blue Dot" className="w-4 h-3 object-contain" />
